...
import { Box, TextField, Button, Typography, Paper, Container, IconButton, InputAdornment, Snackbar, Alert } from '@mui/material';
...
const Login = () => {
    ...
    const onSubmit = (data) => {
        signInWithEmailAndPassword(auth, data.email, data.password).then((auth) => {
            if (auth) {
                navigate("/");
    ...
    return (
        <Container maxWidth="sm">
            ...
            >
                ...
                <Typography variant="h4" component="h2" gutterBottom >Log In</Typography>
                <form onSubmit={handleSubmit(onSubmit)} style={styles.form}>
                    ...
                    <Box style={{ mt: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Link to="/forget-password"><Typography variant="body2">Forget password</Typography></Link>
                        <Link to="/register"><Typography variant="body2">Register Now</Typography></Link>
                    </Box>
